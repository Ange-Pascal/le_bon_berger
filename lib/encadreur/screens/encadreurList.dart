                    ...
                    if (controller.isLoading.value == true ) {
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  'Aucun encadreur ...',
                                  style: GoogleFonts.poppins(
                                      fontSize: 15, color: Colors.grey, fontStyle: FontStyle.italic, fontWeight: FontWeight.bold),
                                ),
                              ), 
                      ...
                      return Container(
                        ...
                        child: ListTile(
                                ...
                                onTap: () {
                                  Get.defaultDialog(
                                    ...
                                    confirm: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        controller.deleteEncadreur(
                                          controller.encadreurs[0],
                                        );
                                      },
                                      child: Text(
                                        'Oui, Supprimer',
                          ...
                          title: Text(
                              "${controller.encadreurs[index].name}  ${controller.encadreurs[index].prenom}",
                              style: GoogleFonts.poppins(
                                  fontWeight: FontWeight.bold, fontSize: 18)),
                          subtitle: Text(
                              "Email: ${controller.encadreurs[index].email}"),
